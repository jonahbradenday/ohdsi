...
The setup script below is used to install the **test** package. You will need to modify this setup script as follows:
                                                                                              
- Set the `projectRootFolder` variable to the directory specific to your environment. In this example we are using `C:/test`. This root folder will serve a few purposes:
...
projectFolder <- "D:/Users/j.bradenday/Documents/R Projects/ohdsi/prediction_study_34_export"
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/test/main/renv.lock", "renv.lock")
...
# finally install the test package
install.packages('devtools', dependencies = FALSE)
devtools::install_github('ohdsi-studies/test')
...
You can safely continue by pressing 'y' after this prompt since the renv.lock file is downloaded from the **test** GitHub code repository. Once the installation is complete, you may need to restart R (if you are working outside of RStudio) and you should see this message:

````
Project 'C:/test' loaded. [renv 0.x.y]
````
