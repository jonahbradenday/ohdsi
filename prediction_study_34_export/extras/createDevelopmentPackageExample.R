...
#devtools::source_url("https://raw.github.com/ohdsi/test/issue242/extras/createDevelopmentPackageFunctions.R")
...
createDevelopmentPackage(
  jsonList = jsonList, 
  baseUrl = baseUrl,
  #skeletonLocation = 'D:/GitHub/test', 
  skeletonUrl = "https://github.com/ohdsi/test/archive/master.zip",
